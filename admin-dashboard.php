  ...
  <body>
    ...
    <main class="dashboard-page">
      <div class="dashboard-container">
        ...
        <aside class="dashboard-sidebar">
          <div class="user-card">
            <div class="user-avatar" id="sidebar-avatar" style="<?php echo $userData['photo'] ? 'background-image: url(' . htmlspecialchars($userData['photo']) . '); background-size: cover; background-position: center;' : ''; ?>">
              <?php if (!$userData['photo']) echo '👤'; ?>
            </div>
            <label for="sidebar-avatar-input" class="avatar-upload-link">Update Foto</label>
            <input type="file" id="sidebar-avatar-input" accept="image/*" hidden onchange="uploadPhoto(event)" />
            ...
            <section class="tab-content">
              ...
              <div class="profile-form">
                <div class="profile-avatar-card">
                  <div class="profile-avatar-photo" id="profile-avatar" style="<?php echo $userData['photo'] ? 'background-image: url(' . htmlspecialchars($userData['photo']) . '); background-size: cover; background-position: center;' : ''; ?>">
                    <?php if (!$userData['photo']) echo '👤'; ?>
                  </div>
                  <div>
                    <p class="profile-avatar-label">Foto Profil</p>
                    <label for="profile-avatar-input" class="btn-upload">Unggah Foto</label>
                    <input type="file" id="profile-avatar-input" accept="image/*" hidden onchange="uploadPhoto(event)" />
                  </div>
                </div>
                <div class="form-group">
                  <label>Nama Lengkap</label>
                  <input type="text" id="edit-name" value="<?php echo htmlspecialchars($userData['name']); ?>" />
                </div>
                <div class="form-group">
                  <label>Email</label>
                ...
                <div class="form-group">
                  ...
                  <input type="tel" id="edit-phone" value="<?php echo htmlspecialchars($userData['phone']); ?>" />
                </div>
                <div class="form-group">
    ...
    <script>
      ...
      function saveProfile() {
        ...
        formDataName.append('action', 'update_name');
        ...
        .then(data => {
          ...
          // Simpan telepon jika ada perubahan
          if (phone) {
            const formDataPhone = new FormData();
            formDataPhone.append('action', 'update_phone');
            formDataPhone.append('phone', phone);

            return fetch('update_admin.php', {
              method: 'POST',
              body: formDataPhone
            })
            .then(response => response.json())
